...
return function(bufnr)
	...
	keymap("n", "pc", dap.continue, { desc = "Dap: Continue", silent = true })
	keymap("n", "po", dap.step_over, { desc = "Dap: Step Over", silent = true })
	keymap("n", "pi", dap.step_into, { desc = "Dap: Step Into", silent = true })
	keymap("n", "pO", dap.step_out, { desc = "Dap: Step Out", silent = true })

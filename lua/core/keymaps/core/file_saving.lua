...
return function(bufnr)
	...
	keymap_util.map_for_all_and_terminal("<C-y><C-q>", "<Cmd>qa<CR>", { desc = "Quit All", silent = true })
	keymap_util.map_for_all_and_terminal("<C-y><C-s>", "<Cmd>wa<CR>", { desc = "Save All", silent = true })
	keymap_util.map_for_all_and_terminal("<C-y><C-x>", "<Cmd>wqa<CR>", { desc = "Save All & Quit", silent = true })

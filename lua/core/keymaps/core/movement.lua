...
return function(bufnr)
	...
	keymap("i", "<C-a>", "<C-o>^", { desc = "Move to beginning of line" })
	...
	keymap("i", "<C-d>", "<C-o>x", { desc = "Delete character under cursor" })
	keymap("i", "<C-h>", "<BS>", { desc = "Delete character before cursor" })
	keymap("i", "<M-d>", "<C-o>daw", { desc = "Delete word after cursor" })
	keymap("i", "<M-BS>", "<C-o>db", { desc = "Delete word before cursor" })
	keymap("i", "<C-k>", "<C-o>D", { desc = "Kill from cursor to end of line" })
	keymap("i", "<C-u>", "<C-o>d0", { desc = "Kill from cursor to beginning of line" })
